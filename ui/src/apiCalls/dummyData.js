const activitiesData = {
  activities: [
    ...
    },
    {
      ...
      instructions:
        ["Put different textured objects in a bag and let your child pull them out one by one", "Make sure that objects are nontoxic and big enough not to be a choking hazard, since they are likely to end up in your child's mouth"],
      indoor: true,
      outdoor: false,
      motorSkill: ["fine"],
    },
    {
      ...
      materials: [
        ...
        "blankets",
        "furniture",
        "outdoor materials: towels, blow up toys",
      ],
      instructions:
        ["Toss blankets over furniture to create tunnels to crawl through","toss pillows on the floor to jump onto if child is older or to crawl over if younger","Place a prize at the end of the course or make the course a circle", "go outside for more space"],
      indoor: true,
      outdoor: true,
      motorSkill: ["gross"],
    },
    ...
    },
    {
      ...
      name: "car painting",
      materials: [
        "at least 3 matchbox cars",
        "paint",
        "cardboard box or butcher paper",
      ],
      instructions:
    ...
    },
    {
      ...
      name: "ice painting",
      materials: [
        "enough ice to fill a plastic bin",
        "plastic bin",
        "paint and brushes",
      ],
      instructions:
